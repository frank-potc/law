...
CREATE TABLE IF NOT EXISTS public.activo_riesgo_medidas

(
    id integer NOT NULL DEFAULT nextval('activo_riesgo_medidas_id_seq'::regclass),
    empresa_id integer,
    activo_id integer,
    ...
    CONSTRAINT activo_riesgo_medidas_pkey PRIMARY KEY (id)
)
...
CREATE TABLE IF NOT EXISTS public.riesgo_legals
(
    id integer NOT NULL DEFAULT nextval('riesgo_legals_id_seq'::regclass),
    nombre character varying COLLATE pg_catalog."default",
    criticidad integer,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
